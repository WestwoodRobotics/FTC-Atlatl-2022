...
import org.firstinspires.ftc.teamcode.drive.opmode2.RobotCanvas;
    ...
    private void draw(
        ...
        if (sequence != null) {
            for (int i = 0; i < sequence.size(); i++) {
                ...
                if (segment instanceof TrajectorySegment) {
                    ...
                    RobotCanvas.drawSampledPath(fieldOverlay, ((TrajectorySegment) segment).getTrajectory().getPath());
        ...
        if (currentSegment != null) {
            if (currentSegment instanceof TrajectorySegment) {
                ...
                RobotCanvas.drawSampledPath(fieldOverlay, currentTrajectory.getPath());
            } else if (currentSegment instanceof TurnSegment) {
        ...
        if (targetPose != null) {
            ...
            RobotCanvas.drawRobot(fieldOverlay, targetPose);
        }

        fieldOverlay.setStroke("#3F51B5");
        RobotCanvas.drawPoseHistory(fieldOverlay, poseHistory);

        fieldOverlay.setStroke("#3F51B5");
        RobotCanvas.drawRobot(fieldOverlay, poseEstimate);
    }
