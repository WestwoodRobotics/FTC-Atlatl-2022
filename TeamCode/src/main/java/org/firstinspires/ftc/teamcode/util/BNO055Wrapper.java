...
public final class BNO055Wrapper {
    ...
    public AngularVelocity getAngularVelocity() {
        AngularVelocity rawVel = bno.getAngularVelocity().toAngleUnit(AngleUnit.RADIANS);

        // intentionally reordered to mitigate https://github.com/FIRST-Tech-Challenge/FtcRobotController/issues/251
        return new AngularVelocity(AngleUnit.RADIANS,
                -rawVel.zRotationRate, rawVel.yRotationRate, rawVel.xRotationRate,
                rawVel.acquisitionTime);
    }
